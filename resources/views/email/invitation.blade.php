...
<head>
    ...
    <title>Platinummilescorporate Invitation</title>
</head>
...
<body style="background-color: #eaf0f2;">
    <div
        ...
        <div style="border-radius: 10px; background-color: #fff; margin-top: 30px; padding: 10px 20px;">
            <p style="text-align: center; color: #29aae1; font-size: 18px;"><strong>Hi, {{ $name }},ss</strong></p>

            <p>Congratulation your  are invited <a href="{{ $url }}/join-now?company-code={{ $company_code }}">click here</a> </p>
       Platinummilescorporate.</strong></a></p>
      
            
            <p>
                <strong>Your  Comapny Code here:</strong> {{ $company_code }}
            </p>
