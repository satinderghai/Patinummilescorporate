        ...
        <div class="nk-block">
          ...
          <div class="card">
            ...
            <div class="card-inner">
                @if(Auth::user()->role == 1)
                <div class="text_code my-3">
              <span class="text-right"> <strong> Company Code : </strong></span>  {{$profile->code}}
            </div>
              @endif
              <div class="nk-block">
                <div class="card">
                    ...
                    <div class="card-inner card-inner-lg profile-setting-section">
                      ...
                      <div class="nk-block">
                       ...
                       <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                              ...
                              <span class="data-value">{{ $profile->company_name }}</span>
                            </div>
...
@endif
  ...
  @if(Auth::user()->role == 1)
   <img src="{{ asset('public/backend/images/') }}/{{ $profile->company_logo }}" class="thumb" alt="User Image" style="max-width: 83px;">
                      ...
                      <div class="card-inner">
                        <div class="user-card">
                          <div class="user-avatar bg-primary">
                                                     @if(Auth::user()->role == 1)
 <img src="{{ asset('public/backend/images/') }}/{{ $profile->company_logo }}" class="thumb" alt="User Image">
    @else
                                 @if(Auth::user()->image != null)
                               <img src="{{ asset('public/backend/images/profile/') }}/{{ Auth::user()->image }}" class="thumb" alt="User Image">
                               @else
                               
                               <img src="{{ asset('public/backend/images/profile/default.png') }}" class="thumb"alt="User Image">
                            ...
                            <div class="row gy-4">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  {!! Form::text('name', null, ['class' => 'form-control form-control-lg', 'id' => 'full-name']) !!}
                                  @if ($errors->has('name'))
                                  <p style="color:red;">
                                    {!!$errors->first('name')!!}
                                  </p>
