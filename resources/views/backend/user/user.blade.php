            ...
            <div class="col-xxl-12">
              ...
              <div class="card card-full">
                <div class="card-inner">
                  <form class="card-form" action="{{ url('admin/update-user-profile') }}" method="post" enctype="multipart/form-data">
                    @csrf
                          <input type="file" name="image" id="logoUpload"  accept="image/*" onchange="loadFile(event)" style="display:none"/> 
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label class="form-label" for="name">User
                          Logo</label>&nbsp;&nbsp;&nbsp;&nbsp;

                          <div class="ui-code">
                          <label class="form-label text-right" for="name">User
                          Code  &nbsp;&nbsp;</label><span><strong>{{ (isset($getUserInfor->code)) ? $getUserInfor->code : '' }}</strong></span>
                          </div>
                          ...
                          <div class="form-control-wrap">
                            <div class="comp-logo-wrap">
                              @if(!empty($getUserInfor->image))
                              <img id="blah" class="comp-logo" src="{{ url('/') }}/public/backend/images/{{ $getUserInfor->image }}"
                              alt="Image">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="form-control-wrap">
                            ...
                            value="{{ (isset($getUserInfor->company_name)) ? $getUserInfor->company_name : '' }}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="form-control-wrap">
                            ...
                            value="{{ (isset($getUserInfor->name)) ? $getUserInfor->name : '' }}">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="form-control-wrap">
                            ...
                            value="{{ (isset($getUserInfor->email)) ? $getUserInfor->email : '' }}">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="form-control-wrap">
                            ...
                            value="{{ (isset($getUserInfor->phone)) ? $getUserInfor->phone : '' }}">
                          </div>
                        </div>
                      </div>
                                               <!--              <div class="col-sm-6">
