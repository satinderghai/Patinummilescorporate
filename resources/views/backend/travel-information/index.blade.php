        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ (isset(Auth::user()->email)) ? Auth::user()->email : '' }}" placeholder="email@domain.com"  autocomplete="email" autofocus>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
             ...
             <div class="form-group ">
                ...
                <div class="form-control-wrap">
                    <input id="key_code" type="text" name="key_code" value="{{ (isset(Auth::user()->key_code)) ? Auth::user()->key_code : '' }}" class="form-control form-control-lg @error('key_code') is-invalid @enderror"
...
<input type="hidden" id="user_member_id" name="user_member_id" value="{{ (isset(Auth::user()->id)) ? Auth::user()->id : '' }}">

<input type="hidden" id="admin_created" name="admin_created" value="yes">
