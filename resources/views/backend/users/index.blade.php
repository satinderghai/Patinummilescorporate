                ...
                <div class="nk-block">
                    ...
                    <div class="card">
                        <div class="export-button">
                         <span data-href="{{ url('/')}}/admin/export-csv" id="export" class="btn btn-danger btn-sm" onclick ="exportTasks (event.target);">Export</span>
                         </div>
                              ...
                              <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col tb-col-sm">
                                        ...
                                        <td class="nk-tb-col">
                                         ...
                                         <span class="tb-status text-danger" style="color:red !important;">Rejected</span>
                                         @endif
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                       <ul class="link-list-opt no-bdr">
                                                                ...
                                                                <li><a href="{{action('App\Http\Controllers\backend\UserController@edit', $value['id'])}}"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                 ...
                                                                 <li><a href="{{url('admin/approve-user')}}/{{ $value->id }}" onclick="return confirm('Are you sure?')"><em class="icon fas fa-circle-check"></em><span>Approve</span></a></li>
                                                                     @endif

                                                                   @if($value->is_verify == 1)
                                                                  <li><a href="{{url('admin/reject-user')}}/{{ $value->id }}"onclick="return confirm('Are you sure?')"><em class="icon fas fa-remove"></em><span>Reject</span></a></li>
                                                                    @endif
