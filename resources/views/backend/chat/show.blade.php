                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">User Information / <strong class="text-primary small">{{ $getUserInfo->name }}</strong></h3>
                                            <div class="nk-block-des text-soft">
                                                <ul class="list-inline">
                                                    <li>User ID: <span class="text-base">UD{{ $getUserInfo->id }}</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="nk-block-head-content">
                                                       ...
                                                       <!--      <div class="profile-ud-item">
                                                            ...
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    ...
                                                                    <span class="profile-ud-value">{{ $getUserInfo->phone }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
